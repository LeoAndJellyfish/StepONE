...
示例：python build.py 1.0.0
       python build.py 1.0.0 --platforms=macos
       python build.py 1.0.0 --platforms=windows,android,macos
"""
...
示例:
  ...
  python build.py 1.0.0 --platforms=macos
  python build.py 1.0.0 --platforms=windows,android,macos
  python build.py 1.0.0 --all-platforms
        """
    )
