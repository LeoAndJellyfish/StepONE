...
示例：python build_and_package.py 1.0.0
       python build_and_package.py 1.0.0 --platforms=macos
       python build_and_package.py 1.0.0 --platforms=windows,android,macos
       python build_and_package.py 1.0.0 --all-platforms
